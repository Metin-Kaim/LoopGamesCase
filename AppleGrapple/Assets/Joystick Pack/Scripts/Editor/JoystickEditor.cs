...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty handle1;
    ...
    public override void OnInspectorGUI()
    {
        ...
        if(handle1 != null)
        {
            RectTransform handleRect = (RectTransform)handle1.objectReferenceValue;
    ...
    protected virtual void DrawComponents()
    {
        ...
        EditorGUILayout.ObjectField(handle1, new GUIContent("Handle1", "The handle's RectTransform component."));
    }
}